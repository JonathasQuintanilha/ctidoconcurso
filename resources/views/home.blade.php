    ...
    <section id="home-slider">
        <div class="container">
            <div class="row">
              ...
              <ul class="bxslider">
                <li><a href="route"><img title="Teste" src="/images/home/slider/slide1.jpg" /></a></li>
                <li><a href="route"><img src="/images/home/slider/slide2.jpg" /></a></li>
                <li><a href="route"><img src="/images/home/slider/slide3.jpg" /></a></li>
                <li><a href="route"><img src="/images/home/slider/slide4.jpg" /></a></li>
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                            <img src="/images/home/foco.png" alt="">
                        </div>
                        <h2>Foco nas principais bancas</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam rhoncus aliquet velit sed scelerisque.</p>
                    </div>
                </div>
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="600ms">
                            <img src="/images/home/organizacao.png" alt="">
                        </div>
                        <h2>Organização</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam rhoncus aliquet velit sed scelerisque.</p>
                    </div>
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="900ms">
                            <img src="/images/home/simplicidade.png" alt="">
                        </div>
                        <h2>Simplicidade</h2>
                ...
                <div class="row">
                    <div class="action take-tour">
                        <div class="col-sm-7 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                            <h1 class="title">Acesse ao material gratuito</h1>
                            <p>Basta clicar no botão ao lado e participe</p>
                        </div>
                        <div class="col-sm-5 text-center wow fadeInRight" data-wow-duration="500ms" data-wow-delay="300ms">
                            <div class="tour-button">
                                <a href="#" class="btn btn-common">INSCREVA-SE</a>
                             </div>
                        </div>
                    </div>
                </div>
